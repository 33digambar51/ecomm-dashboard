...
function Register() {
    ...
    function SignUp(e) {
        ...
        if (!(email)) {
            ...
            // Fetch API Url and Get Email For Match Email (Email-Redundancy) => Email Should Not be same
            ...
            fetch("http://localhost:8000/users/").then((data) => {
                data.json().then((resp) => {
                    ...
                    const dbemail = [...new Set(resp.map((userElem, i) => {
                        return userElem.email;
                    }))];
                    console.log("Dtmail", dbemail);
            ...
            <section className="py-5">
                <div className="col-sm-6 offset-sm-3 card-box">
                    <form onSubmit={SignUp}>
                        <h2 className="text-center mb-4">User Register Form</h2>
                        ...
                        <div className="d-flex justify-content-center mt-2">
                            <span>Do you have account?</span><Link to="/login" className="ml-1">Login</Link>
                        </div>
                    </form>
                </div>
            </section>
