...
const options = {
    ...
    // navText:["<div className='nav-btn prev-slide'><img src='images/prev.png' alt='prev'/></div>","<div className='nav-btn next-slide'><img src='images/next.png' alt='next'/></div>"],
    nav: true,
    rewind: true,
    autoplay: true,
    slideBy: 1,
...
function Home() {
    ...
    return (
        <>
            <Header />
            <section className="mt-n3 banner-owl-slider">
            ...
            <section className="py-5 text-center">
                <div className="container">
                    ...
                    <div className="row">
                        {
                            data.sort(() => Math.random() - Math.random()).slice(0, 6).map((item, id) =>
                            ...
                            <div className="">
                                <div className="card shadow">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <h6 className="card-title">Price: 25000</h6>
